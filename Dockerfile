...
ARG JAR_FILE=target/aws-codepipeline-1.0-SNAPSHOT.jar

ADD ${JAR_FILE} aws-codepipeline-1.0-SNAPSHOT.jar

ENTRYPOINT ["java", "-Djava.security.edg=file:/dev/./urandom","-jar", "/aws-codepipeline-1.0-SNAPSHOT.jar"]